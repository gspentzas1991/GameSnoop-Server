The server for https://www.GameSnoop.gg, written in python with Flask. Powered by the `Simple-Steam-Queries <https://github.com/gspentzas1991/Simple-Steam-Queries>`_ library
